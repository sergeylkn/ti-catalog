"""
Parser stub for ochystka-ta-zmyvannya_aksesuary-dlya-zmashchuvannya.pdf
...
def parse_ochystka_ta_zmyvannya_aksesuary_dlya_zmashchuvannya_pdf(pdf_path: str) -> List[Dict]:
    ...
    config = {"filename": "ochystka-ta-zmyvannya_aksesuary-dlya-zmashchuvannya.pdf", "url": "https://pub-ada201ec5fb84401a3b36b7b21e6ed0f.r2.dev/ochystka-ta-zmyvannya_aksesuary-dlya-zmashchuvannya.pdf", "pages": 1, "layout_type": "table_heavy", "scanned": false, "tables_found": 3, "images_found": 14, "recommended_parsers": {"text_extraction": "pymupdf/pdfplumber", "ocr": null, "table_parser": "camelot/tabula", "image_extraction": true, "segment_strategy": "page_sectioning"}, "sample_text_len": 1529, "regex_sku": "[A-Z0-9\\-_/]{4,}", "regex_dimension": "(\\d+(?:\\.\\d+)?)\\s*(mm|cm|m)", "regex_pressure": "(\\d+(?:\\.\\d+)?)\\s*(bar|MPa)"}
