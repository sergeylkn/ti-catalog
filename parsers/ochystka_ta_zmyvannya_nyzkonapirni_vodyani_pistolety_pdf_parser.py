"""
Parser stub for ochystka-ta-zmyvannya_nyzkonapirni-vodyani-pistolety.pdf
...
def parse_ochystka_ta_zmyvannya_nyzkonapirni_vodyani_pistolety_pdf(pdf_path: str) -> List[Dict]:
    ...
    config = {"filename": "ochystka-ta-zmyvannya_nyzkonapirni-vodyani-pistolety.pdf", "url": "https://pub-ada201ec5fb84401a3b36b7b21e6ed0f.r2.dev/ochystka-ta-zmyvannya_nyzkonapirni-vodyani-pistolety.pdf", "pages": 15, "layout_type": "table_heavy", "scanned": false, "tables_found": 8, "images_found": 17, "recommended_parsers": {"text_extraction": "pymupdf/pdfplumber", "ocr": null, "table_parser": "camelot/tabula", "image_extraction": true, "segment_strategy": "page_sectioning"}, "sample_text_len": 9562, "regex_sku": "[A-Z0-9\\-_/]{4,}", "regex_dimension": "(\\d+(?:\\.\\d+)?)\\s*(mm|cm|m)", "regex_pressure": "(\\d+(?:\\.\\d+)?)\\s*(bar|MPa)"}
