"""
Parser stub for ochystka-ta-zmyvannya_obpresovky-dlya-shlanhiv-ta-myyky.pdf
...
def parse_ochystka_ta_zmyvannya_obpresovky_dlya_shlanhiv_ta_myyky_pdf(pdf_path: str) -> List[Dict]:
    ...
    config = {"filename": "ochystka-ta-zmyvannya_obpresovky-dlya-shlanhiv-ta-myyky.pdf", "url": "https://pub-ada201ec5fb84401a3b36b7b21e6ed0f.r2.dev/ochystka-ta-zmyvannya_obpresovky-dlya-shlanhiv-ta-myyky.pdf", "pages": 5, "layout_type": "table_heavy", "scanned": false, "tables_found": 17, "images_found": 21, "recommended_parsers": {"text_extraction": "pymupdf/pdfplumber", "ocr": null, "table_parser": "camelot/tabula", "image_extraction": true, "segment_strategy": "page_sectioning"}, "sample_text_len": 3692, "regex_sku": "[A-Z0-9\\-_/]{4,}", "regex_dimension": "(\\d+(?:\\.\\d+)?)\\s*(mm|cm|m)", "regex_pressure": "(\\d+(?:\\.\\d+)?)\\s*(bar|MPa)"}
