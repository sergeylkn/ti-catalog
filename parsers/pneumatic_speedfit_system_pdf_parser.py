"""
Parser stub for pneumatic_speedfit_system.pdf
...
def parse_pneumatic_speedfit_system_pdf(pdf_path: str) -> List[Dict]:
    ...
    config = {"filename": "pneumatic_speedfit_system.pdf", "url": "https://pub-ada201ec5fb84401a3b36b7b21e6ed0f.r2.dev/pneumatic_speedfit_system.pdf", "pages": 5, "layout_type": "table_heavy", "scanned": false, "tables_found": 15, "images_found": 23, "recommended_parsers": {"text_extraction": "pymupdf/pdfplumber", "ocr": null, "table_parser": "camelot/tabula", "image_extraction": true, "segment_strategy": "page_sectioning"}, "sample_text_len": 3569, "regex_sku": "[A-Z0-9\\-_/]{4,}", "regex_dimension": "(\\d+(?:\\.\\d+)?)\\s*(mm|cm|m)", "regex_pressure": "(\\d+(?:\\.\\d+)?)\\s*(bar|MPa)"}
