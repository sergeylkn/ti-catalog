"""
Parser stub for promyslova-armatura_ushchilnennya-ta-kripylni-bolty-dlya-flantsevykh-zyednan.pdf
...
def parse_promyslova_armatura_ushchilnennya_ta_kripylni_bolty_dlya_flantsevykh_zyednan_pdf(pdf_path: str) -> List[Dict]:
    ...
    config = {"filename": "promyslova-armatura_ushchilnennya-ta-kripylni-bolty-dlya-flantsevykh-zyednan.pdf", "url": "https://pub-ada201ec5fb84401a3b36b7b21e6ed0f.r2.dev/promyslova-armatura_ushchilnennya-ta-kripylni-bolty-dlya-flantsevykh-zyednan.pdf", "pages": 2, "layout_type": "table_heavy", "scanned": false, "tables_found": 10, "images_found": 11, "recommended_parsers": {"text_extraction": "pymupdf/pdfplumber", "ocr": null, "table_parser": "camelot/tabula", "image_extraction": true, "segment_strategy": "page_sectioning"}, "sample_text_len": 6213, "regex_sku": "[A-Z0-9\\-_/]{4,}", "regex_dimension": "(\\d+(?:\\.\\d+)?)\\s*(mm|cm|m)", "regex_pressure": "(\\d+(?:\\.\\d+)?)\\s*(bar|MPa)"}
